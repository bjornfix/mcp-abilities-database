...
const assertions = [
  ...
  [/array\( 'columns' => array\( 'user_login' \), 'unique' => false \)/, 'canonical WordPress user_login index is treated as non-unique'],
  ...
  [/'returned_issue_count'/, 'issue details are bounded to the returned table page'],
  [/'issues_truncated'/, 'bounded issue detail truncation is explicit'],
